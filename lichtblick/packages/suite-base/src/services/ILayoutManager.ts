...
export interface ILayoutManager {
  ...
  /**
   * Install a layout from marketplace
   *
   * @param params - Installation parameters including marketplace detail and optional name
   * @returns Promise<Layout> The installed layout
   */
  installFromMarketplace?(params: {
   ...
   *
   * @param layoutId - The layout ID to mark
   * @param marketplaceId - The marketplace ID of the original layout
   ...
   * @returns Promise<string | undefined> The marketplace ID if the layout is from marketplace
   */
