...
/**
 * バージョン情報を安全に文字列として取得する
 * @param version - バージョン情報（文字列またはオブジェクト）
 * @returns バージョン文字列
 */
      ...
      <Stack gap={1} alignItems="flex-start">
        <Stack gap={0.5} paddingBottom={1}>
          <Stack direction="row" gap={1} alignItems="baseline">
            ...
            >{`v${getVersionString(extension.version)}`}</Typography>
