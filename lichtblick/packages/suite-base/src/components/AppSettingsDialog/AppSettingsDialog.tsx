...
import SoraExtensionsMarketplaceSettings from "@lichtblick/suite-base/components/SoraExtensionsMarketplaceSettings/SoraExtensionsMarketplaceSettings";
import SoraLayoutMarketplaceSettings from "@lichtblick/suite-base/components/SoraLayoutMarketplaceSettings";
...
export function AppSettingsDialog(
  ...
  const extensionSettingsComponent = extensionMarketplaceSettings ?? (
    <SoraExtensionsMarketplaceSettings />
  );
  const layoutMarketplaceComponent = layoutMarketplaceSettings ?? <SoraLayoutMarketplaceSettings />;
    ...
    <Dialog {...props} fullWidth maxWidth="md" data-testid={`AppSettingsDialog--${activeTab}`}>
      ...
      <div className={classes.layoutGrid}>
        ...
        >
          ...
          <Tab className={classes.tab} label={t("layouts")} value="layouts" />
          <Tab
        ...
        <Stack direction="row" fullHeight overflowY="auto">
          ...
          <section
            className={cx(classes.tabPanel, {
              [classes.tabPanelActive]: activeTab === "layouts",
            })}
          >
            <Stack gap={2}>{layoutMarketplaceComponent}</Stack>
          </section>
