...
import SoraLayoutCatalogProvider from "./providers/SoraLayoutCatalogProvider";
import SoraLayoutMarketplaceProvider from "./providers/SoraLayoutMarketplaceProvider";
...
export function App(props: AppProps): React.JSX.Element {
  ...
  providers.unshift(<SoraLayoutCatalogProvider />);
  providers.unshift(<SoraLayoutMarketplaceProvider />);
