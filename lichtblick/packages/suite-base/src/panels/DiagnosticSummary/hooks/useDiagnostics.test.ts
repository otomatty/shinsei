...
import DiagnosticsBuilder from "@lichtblick/suite-sting/builders/DiagnosticsBuilder";
import MessageEventBuilder from "@lichtblick/suite-sting/builders/MessageEventBuilder";
...
jest.mock("@lichtblick/suite-nelAPI");
